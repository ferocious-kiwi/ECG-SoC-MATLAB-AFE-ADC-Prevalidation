# MATLAB-Based ECG AFE+ADC Nominal Pre-Validation
...
This repository provides MATLAB-based nominal pre-validation of the ECG AFE+ADC chain.  
Its role is to define schematic-derived filter parameters, ADC dynamic range, code mapping, and reference vectors before SystemVerilog XMODEL implementation.
